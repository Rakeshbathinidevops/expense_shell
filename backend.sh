...
cp /home/ec2-user/expense_shell/backend.service /etc/systemd/system/backend.service &>>$LOGFILE
...
mysql -h 172.31.35.234 -uroot -pExpenseApp@1 < /app/schema/backend.sql &>>$LOGFILE
